class UserStocksController < ApplicationController
  ...
  def create
    if params[:stock_id].present?
      ...
      stock = Stock.find_by_ticker(params[:stock_symbol])
      if stock
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: "Now following #{@user_stock.stock.symbol}" }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock Removed' }
